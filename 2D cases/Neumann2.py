...
domain = mshr.Ellipse(df.Point(0.5,0.5),df.sqrt(2.0)/4.0, 1.0/4.0) # creation of the domain
for i in range(start, end, step):
...
plt.tight_layout()
plt.savefig('Neumann2/relative_error_P_{name0}.png'.format(name0=degV))
plt.show()
...
plt.tight_layout()
plt.savefig('Neumann2/Time_precision_P_{name0}.png'.format(name0=degV))
plt.show()
plt.figure()
...
plt.legend(loc='upper right')
plt.tight_layout()
plt.savefig('Neumann2/Time_error_P_{name0}.png'.format(name0=degV))
plt.show()
plt.figure()
...
plt.legend(loc='upper right')
plt.tight_layout()
plt.savefig('Neumann2/Total_time_error_P_{name0}.png'.format(name0=degV))
plt.show()
#  Write the output file for latex
f = open('Neumann2/output_ghost_P{name0}.txt'.format(name0=degV),'w')
