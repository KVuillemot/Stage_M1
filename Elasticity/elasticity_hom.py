...
# degree of in+terpolation for V and Vphi
degV = 1
degPhi = 1 + degV 
...
plt.tight_layout()
plt.savefig('Elasticity_Dirichlet_homo/relative_error_P_{name0}.png'.format(name0=degV))
plt.show()
...
plt.tight_layout()
plt.savefig('Elasticity_Dirichlet_homo/Time_precision_P_{name0}.png'.format(name0=degV))
plt.show()
plt.figure()
...
plt.legend(loc='upper right')
plt.tight_layout()
plt.savefig('Elasticity_Dirichlet_homo/Time_error_P_{name0}.png'.format(name0=degV))
plt.show()
plt.figure()
...
plt.legend(loc='upper right')
plt.tight_layout()
plt.savefig('Elasticity_Dirichlet_homo/Total_time_error_P_{name0}.png'.format(name0=degV))
plt.show()
