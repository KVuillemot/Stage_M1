...
plt.tight_layout()
plt.savefig('Dirichlet_Neumann/relative_error_P_{name0}.png'.format(name0=degV))
plt.show()
...
plt.tight_layout()
plt.savefig('Dirichlet_Neumann/Time_precision_P_{name0}.png'.format(name0=degV))
plt.show()
plt.figure()
...
plt.legend(loc='upper right')
plt.tight_layout()
plt.savefig('Dirichlet_Neumann/Time_error_P_{name0}.png'.format(name0=degV))
plt.show()
plt.figure()
...
plt.legend(loc='upper right')
plt.tight_layout()
plt.savefig('Dirichlet_Neumann/Total_time_error_P_{name0}.png'.format(name0=degV))
plt.show()
"""
#  Write the output file for latex
f = open('Dirichlet_Neumann/output_ghost_P{name0}.txt'.format(name0=degV),'w')
